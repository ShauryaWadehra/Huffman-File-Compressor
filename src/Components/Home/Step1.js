...
export default function Step1()
{
    ...
    return (<div className="pb-10" id="step1">
        ...
        <div className="flex justify-around mt-10">
            ...
            <label for="uploadfile" className="hover:duration-200 hover:cursor-pointer bg-red-500 rounded-md p-3 px-5 mt-5 text-white text-2xl font-semibold hover:bg-[#161616]">{form.length===0?(CompressState?"Select TEXT file":"Select Image"):(form.name.substring(0,17)+"..."+extension)}</label>
        </div>
